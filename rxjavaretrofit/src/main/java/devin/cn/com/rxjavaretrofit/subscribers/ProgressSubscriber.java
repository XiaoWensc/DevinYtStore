package devin.cn.com.rxjavaretrofit.subscribers;
        ...
        Observable.just(api.getUrl()).subscribe(new Subscriber<String>() {
            ...
            public void onNext(String s) {
                ...
                if (time < api.getCookieNoNetWorkTime()) {
                    if (mSubscriberOnNextListener.get() != null) {
                        BaseApi._dynSessConf = JSONObject.parseObject(cookieResulte.getResulte()).getString("sessionConfirmationNumber");
                        mSubscriberOnNextListener.get().onNext(cookieResulte.getResulte(), api.getMethod());
                    }
                } else {
